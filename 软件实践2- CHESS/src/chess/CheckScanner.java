...
public class CheckScanner {
    ...
    public boolean isKingChecked(Move move) {
        ...
        return hitByRock(move.newCol, move.newRow, king, kingCol, kingRow, 0, 1) || // up
                hitByRock(move.newCol, move.newRow, king, kingCol, kingRow, 1, 0) || //right
                hitByRock(move.newCol, move.newRow, king, kingCol, kingRow, 0, -1) || //down
                hitByRock(move.newCol, move.newRow, king, kingCol, kingRow, -1, 0) || //left
    ...
    private boolean checkByKnight(Piece p, Piece k, int col, int row){
